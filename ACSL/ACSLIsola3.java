...
public class ACSLIsola3 {
  ...
  public static void check(int cmarker, int xmarker, int[] empties) {
    ...
    board[cmarkerrow][cmarkercol] = 0; //changed this from cmarker to 0
...
//      for (int i = 1; i != 0 && board not edge && not a piee; i++) {
//        caught.add((Math.max(goodspot, xmarker))-(7*i));
//      }
      int i = 1;
      int j = 0;
      //System.out.println("hi b");
      while(i+xmarkerrow >= 0 && i+xmarkerrow < 7 && j >= 0 && j < 7 && board[i+xmarkerrow][xmarkercol] != 0){
        //caught.add((Math.max(goodspot, xmarker))-(7*i));
        //System.out.println(i);
        //System.out.println(xmarker+(7*i));
   
        caught.add(xmarker+(7*i));
        i++;
...
//      }
      ...
      int j = 1;
      //System.out.println("hi b");
      while(i+xmarkerrow >= 0 && i+xmarkerrow < 7 && j+xmarkercol >= 0 && j+xmarkercol < 7 && board[i+xmarkerrow][j+xmarkercol] != 0){
        //caught.add((Math.max(goodspot, xmarker))-(7*i));
        //System.out.println(i);
        //System.out.println(xmarker+(8*i));
   
        caught.add(xmarker+(8*i));
        i++;
        j++;
...
//      }
      ...
      while(i+xmarkerrow >= 0 && i+xmarkerrow < 7 && j+xmarkercol >= 0 && j+xmarkercol < 7 && board[i+xmarkerrow][j+xmarkercol] != 0){
        //caught.add((Math.max(goodspot, xmarker))-(7*i));
        //System.out.println(i);
        //System.out.println(xmarker+(6*i));
   
        caught.add(xmarker+(6*i));
        i++;
        j++;
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 12; i++) {
      ...
      new ACSLIsola3().check(cmarker, xmarker, empties);
