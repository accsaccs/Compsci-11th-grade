...
public class ACSLIsola {
  ...
  public static int check(int cmarker, int xmarker, int[] empties) {
    ...
    //WHEN THEY'RE HORIZONTALLY ALIGNED
    if((cmarker-xmarker)%7 == 0){
//      for (int i = 0; i < 6; i++) {
//        xmarkerrow++;
//        System.out.println(xmarkerrow);
//        System.out.println("board at: " + board[xmarkerrow][xmarkercol]);
//        if(board[xmarkerrow][xmarkercol] != 1 && board[xmarkerrow][xmarkercol] != cmarker){
//          caught.add(board[xmarkerrow][xmarkercol]);
//          board[xmarkerrow][xmarkercol] = 2; 
//        }
//        else if(board[xmarkerrow][xmarkercol] == 1 || board[xmarkerrow][xmarkercol] == cmarker){
//          System.out.println("stopped");
//        }
      
        int length = ((Math.abs(cmarker-xmarker))/7) - 1;
        for (int i = 1; i < length+1; i++) {
          caught.add((Math.max(cmarker, xmarker))-(7*i));
        }
    ...
    //MOVING TOWARDS TOP LEFT ---  FIX THIS *****
    else if(((cmarker-xmarker)%6 == 0 && (cmarker-xmarker)%8 == 0) || (cmarker-xmarker)%6 == 0){ //FIX THIS
      int length = ((Math.abs(cmarker-xmarker))/6) - 1;
      for (int i = 1; i < length+1; i++) {
        caught.add((Math.max(cmarker, xmarker))-(6*i));
      }
    ...
    else if((cmarker-xmarker)%8 == 0){
      int length = ((Math.abs(cmarker-xmarker))/8) - 1;
      for (int i = 1; i < length+1; i++) {
        caught.add((Math.max(cmarker, xmarker))-(8*i));
      }
    ...
    //FOR FUNKY ONES
    else if((cmarker-xmarker)%8 != 0 && (cmarker-xmarker)%6 != 0 && (cmarker-xmarker)%7 != 0){
      int goodspot = 0;
      
      if(board[cmarkerrow-1][cmarkercol-1] > 1){
        goodspot = board[cmarkerrow-1][cmarkercol-1];
      }    
      else if(board[cmarkerrow-1][cmarkercol] > 1){
        goodspot = board[cmarkerrow-1][cmarkercol];
      }
      else if(board[cmarkerrow-1][cmarkercol+1] > 1){
        goodspot = board[cmarkerrow-1][cmarkercol+1];
      }
      else if(board[cmarkerrow][cmarkercol+1] > 1){
        goodspot = board[cmarkerrow][cmarkercol+1];
      }
      else if(board[cmarkerrow+1][cmarkercol+1] > 1){
        goodspot = board[cmarkerrow+1][cmarkercol+1];
      }
    ...
    int goodspot = 0;
    if(cmarker == 1){
      if(board[cmarkerrow][cmarkercol+1] != 0) goodspot = board[cmarkerrow][cmarkercol+1];
      else if(board[cmarkerrow+1][cmarkercol+1] != 0) goodspot = board[cmarkerrow+1][cmarkercol+1];
      else if(board[cmarkerrow+1][cmarkercol] != 0) goodspot = board[cmarkerrow+1][cmarkercol];
    }
    else if(cmarker == 7){
      if(board[cmarkerrow][cmarkercol-1] != 0) goodspot = board[cmarkerrow][cmarkercol-1];
      else if(board[cmarkerrow+1][cmarkercol-1] != 0) goodspot = board[cmarkerrow+1][cmarkercol-1];
      ...
      if(board[cmarkerrow+1][cmarkercol-1] != 0) goodspot = board[cmarkerrow+1][cmarkercol-1];
      else if(board[cmarkerrow+1][cmarkercol] != 0) goodspot = board[cmarkerrow+1][cmarkercol];
      else if(board[cmarkerrow+1][cmarkercol+1] != 0) goodspot = board[cmarkerrow+1][cmarkercol+1];
    }
      ...
      if(board[cmarkerrow-1][cmarkercol+1] != 0) goodspot = board[cmarkerrow-1][cmarkercol+1];
      else if(board[cmarkerrow][cmarkercol+1] != 0) goodspot = board[cmarkerrow][cmarkercol+1];
      else if(board[cmarkerrow+1][cmarkercol+1] != 0) goodspot = board[cmarkerrow+1][cmarkercol+1];
    }
    else if(cmarker%7 == 0){
      if(board[cmarkerrow-1][cmarkercol-1] != 0) goodspot = board[cmarkerrow-1][cmarkercol-1];
