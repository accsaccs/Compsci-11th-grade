 ...
 * Version 3.0
 */
public class OrbitalSim extends AbstractSimulation {
  ...
  if(Double.parseDouble(ControlPanel.xposearth.getText()) > 0){
    signofx = 1;
  }
  else if(Double.parseDouble(ControlPanel.xposearth.getText()) < 0){
    signofx = -1;
  }
  ...
  //control.setValue("earth tangential velocity", 2.9747E4); //29747 this should be this // used to be 2.955E4
  ...
  planet.get(0).color = ControlPanel.color2.getColor();
  planet.get(0).setXY(Double.parseDouble(ControlPanel.xpossun.getText()), Double.parseDouble(ControlPanel.ypossun.getText()));
  planet.get(0).setMass(Double.parseDouble(ControlPanel.masssun.getText()));
  frame.addDrawable(planet.get(0));

  //planet 1 == earth
  planet.add(new Particle());
  planet.get(1).pixRadius = 3;
  planet.get(1).color = ControlPanel.color1.getColor();
  planet.get(1).setXY(Double.parseDouble(ControlPanel.xposearth.getText()), Double.parseDouble(ControlPanel.yposearth.getText()));
  planet.get(1).setVy(Double.parseDouble(ControlPanel.tanveloearth.getText()));
  planet.get(1).setMass(Double.parseDouble(ControlPanel.massearth.getText()));
  ...
  if(control.getBoolean("moon?")==true){
    ...
    planet.get(2).color = ControlPanel.color3.getColor();
    planet.get(2).setXY(Double.parseDouble(ControlPanel.xposearth.getText())+Double.parseDouble(ControlPanel.xposmoon.getText()), Double.parseDouble(ControlPanel.yposmoon.getText()));
    xmoon = Double.parseDouble(ControlPanel.xposmoon.getText())+Double.parseDouble(ControlPanel.xposearth.getText());
    planet.get(2).setVy(Double.parseDouble(ControlPanel.tanvelomoon.getText()));
    planet.get(2).setMass(Double.parseDouble(ControlPanel.massmoon.getText()));
    frame.addDrawable(planet.get(2));
    framemoon.addDrawable(planet.get(2));
    tracemoon.addPoint(Double.parseDouble(ControlPanel.xposearth.getText())+Double.parseDouble(ControlPanel.xposmoon.getText()), Double.parseDouble(ControlPanel.yposmoon.getText()));
    framemoon.addDrawable(tracemoon);
    planetnum = 0;
  }
  ...
  SimulationControl.createApp(new OrbitalSim());
  }
