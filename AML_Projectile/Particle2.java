 ...
 * November 2014 
 * 
 * This class is basically the same as Particle, but it's slightly different (and used in ProjectileLauncher, not Launcher3). The only
 * difference is that the ball never turns black, and the timestep is .1 (as opposed to .001). 
 ...
 *
 */
public class Particle2 extends Circle {
	 ...
	 * So it moves the ball across the screen. 
	 */
	public void move()
	{		
